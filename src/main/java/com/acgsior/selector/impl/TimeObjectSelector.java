 ...
 */
public class TimeObjectSelector extends PropertySelector {

    private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("K : m a", Locale.getDefault());

    @Override
    public LocalTime select(final Element element, final Optional parentId) {

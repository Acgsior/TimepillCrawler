 ...
 */
public class NotebookBasedCache implements ICrawledDataCacheLogger {
	...
	public void logCachedDiaries() {
		notebookDiaryCache.values()
				.forEach(notebookDiaryCache -> notebookDiaryCache.values().forEach(diary -> logger.info(diary.toString())));
	}
